...
async function createInputFiles() {
    ...
    createFileWithContentIfItDoesntExist(path.join(inputDayPath, "part1.txt"), `{visit https://adventofcode.com/2022/day/${day} and paste the part 1 input here}`);
    createFileWithContentIfItDoesntExist(path.join(inputDayPath, "part2.txt"), `{After completing day 1, visit https://adventofcode.com/2022/day/${day} and paste the part 2 input here}`);
}
